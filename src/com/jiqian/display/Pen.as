package com.jiqian.display 
{
	...
	public class Pen
	{
		public static function createShape(w:Number, h:Number, nColor:Number = 0):Sprite
		{
			var temp:Sprite = new Sprite;
			temp.graphics.beginFill(nColor);
	 ...
	 * @return
	 */
	public static function createRect(w:Number = 10, h:Number = 10, color:Number = 0x000000, alpha:Number = 1):Sprite
	{
