...
SPECIAL PROPERTIES (no plugins required):
	...
	ease : Function - Use any standard easing equation to control the rate of change. For example, 
					  com.jiqian.tween.gs.easing.Elastic.easeOut. The Default is Regular.easeOut.
...
EXAMPLES: 
	...
	5 and a reference to the clip_mc), you'd do so like:
		...
		import com.jiqian.tween.gs.*;
		import com.jiqian.tween.gs.easing.*;
...
CHANGE LOG:
	...
	10.06:
		- Speed improvements
		- Integrated a new com.jiqian.tween.gs.utils.tween.TweenInfo class
...
package com.jiqian.tween.gs {
	import flash.display.*;
	import flash.events.*;
	import flash.utils.*;
	
	import com.jiqian.tween.gs.plugins.*;
	import com.jiqian.tween.gs.utils.tween.*;
	...
	public class TweenLite {
		...
		public static var overwriteManager:Object; //makes it possible to integrate the com.jiqian.tween.gs.utils.tween.OverwriteManager for adding autoOverwrite capabilities
